    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-primary-200">
      <div className="container-custom">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            onClick={toggleMenu}
            className="md:hidden relative z-50 touch-target p-3 rounded-xl hover:bg-primary-50 active:bg-primary-100 transition-all duration-200 group"
          ...
          >
            ...
            <div className={`absolute inset-0 rounded-xl transition-all duration-300 ${
              isMenuOpen ? 'bg-primary-100 scale-110' : 'bg-transparent scale-100'
            }`} />
          </button>
        </div>
        ...
        >
          ...
          {/* Menu Panel */}
          <div 
            className={`absolute top-16 left-0 right-0 bg-white/95 backdrop-blur-md border-b border-primary-200 shadow-2xl transition-all duration-500 ease-out ${
              isMenuOpen 
          ...
          >
            <div className="container-custom">
              ...
              <div className={`border-t border-primary-200 py-6 transition-all duration-500 ${
